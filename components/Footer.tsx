      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="font-grotesk text-neutral-300 mb-6 max-w-md">
              Transforming ideas into digital reality. We're your partner in creating innovative solutions that drive business growth.
            </p>
            <div className="flex space-x-4">
              <a
                href="#"
                className="w-10 h-10 rounded-full flex items-center justify-center transition-colors"
                style={{ backgroundColor: 'rgba(255, 252, 235, 0.1)' }}
              >
          ...
          {/* Services Links */}
          <div>
            <h4 className="font-grotesk text-lg font-semibold mb-4">Services</h4>
            <ul className="space-y-2">
              {footerLinks.services.map((link, index) => (
                <li key={index}>
                  <a
                    href={link.href}
                    className="font-grotesk text-neutral-300 hover:text-white transition-colors"
                  >
                    {link.name}
                  </a>
                </li>
          ...
          {/* Company Links */}
          <div>
            <h4 className="font-grotesk text-lg font-semibold mb-4">Company</h4>
            <ul className="space-y-2">
          ...
          {/* Resources Links */}
          <div>
            <h4 className="font-grotesk text-lg font-semibold mb-4">Resources</h4>
            <ul className="space-y-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <form className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2 rounded-lg border border-neutral-600 focus:outline-none text-white font-grotesk"
        ...
        {/* Bottom Bar */}
        <div className="mt-12 pt-8 border-t border-neutral-700 text-center md:flex md:justify-between md:items-center">
