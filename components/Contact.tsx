        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-12">
            ...
            <div className="rounded-lg p-4 sm:p-6 md:p-8 text-white" style={{ backgroundColor: '#1f1f1f' }}>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <svg className="w-6 h-6 mt-1 mr-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                  <div>
                    <h4 className="font-grotesk font-semibold mb-1">Office Address</h4>
                    <p className="font-grotesk opacity-90">123 Digital Street, Suite 100<br />San Francisco, CA 94107</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-grotesk font-semibold mb-1">Email</h4>
                    <p className="font-grotesk opacity-90">hello@digitalagency.com<br />support@digitalagency.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-grotesk font-semibold mb-1">Phone</h4>
                    <p className="font-grotesk opacity-90">+1 (555) 123-4567<br />+1 (555) 987-6543</p>
                  </div>
                </div>
              </div>

              <div className="mt-8 pt-8 border-t border-white/20">
                <h4 className="font-grotesk font-semibold mb-4">Follow Us</h4>
                <div className="flex space-x-4">
                  <a href="#" className="w-10 h-10 rounded-full flex items-center justify-center transition-colors" style={{ backgroundColor: 'rgba(255, 252, 235, 0.2)' }}>
          ...
          <div className="lg:col-span-2">
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border border-neutral-300 rounded-lg outline-none transition-all font-grotesk"
                    style={{ 
                      backgroundColor: '#fffceb',
                      focusRingColor: '#1f1f1f'
                    }}
                    placeholder="John Doe"
                  />
                </div>
                <div>
                  <label htmlFor="email" className="block text-sm font-grotesk font-medium text-neutral-700 mb-2">
                    Email Address
                  </label>
                  <input
                    type="email"
              ...
              <div>
                <label htmlFor="subject" className="block text-sm font-grotesk font-medium text-neutral-700 mb-2">
                  Subject
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-grotesk font-medium text-neutral-700 mb-2">
                  Message
                </label>
                <textarea
                  id="message"
                  ...
                  required
                  rows={6}
                  className="w-full px-4 py-3 border border-neutral-300 rounded-lg outline-none transition-all resize-none font-grotesk"
                  style={{ 
                    backgroundColor: '#fffceb',
                    focusRingColor: '#1f1f1f'
                  }}
